    ...
    namespace eval $my_idx {
      ...
      proc reloadLog { } {
        ...
        foreach a [array names branch_matches] {
          ...
          set branchrevs($subbranch) [list_comm $branchrevs($stockbranch) $branchrevs($subbranch)]
          gen_log:log D "NEW $subbranch branchrevs $branchrevs($subbranch)"
